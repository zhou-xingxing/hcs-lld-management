...
│  │  IPAllocation / ChangeLog / BackupConfig /          │  │
│  │  BackupRecord                                       │  │
│  └────────────────────────────────────────────────────┘  │
└─────────────────────────────────────────────────────────┘
```
...
│ enabled                     │       │ status                      │
│ frequency                   │       │ method                      │
│ schedule_hour/minute        │       │ target                      │
│ schedule_weekday            │       │ file_size                   │
│ method                      │       │ error_message               │
│ local_path                  │       │ operator                    │
│ endpoint/access_key/...     │       │ started_at / finished_at    │
